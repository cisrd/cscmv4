        ...
        <Card className="border-red-200">
          <CardHeader className="p-0 pt-2">
            ...
            <CardContent className="text-sx">
              <div>
                {isLoading && (
                  <Skeleton className="w-[740px] h-[320px] rounded-2" />
                )}
              </div>
              <Grid
                style={{ height: "250px" }}
              ...
              >
                ...
                <GridColumn
                  title="Food Basket Evolution vs Reference Price"
